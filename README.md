...
- Counter: Extends Label. A label that is meant to display a number. Its main feature is being able to (optionally) animate the amount changing instead of setting it directly. Pretty customizable, has exports for a prefix, suffix, trans/ease for the tweener, etc.
